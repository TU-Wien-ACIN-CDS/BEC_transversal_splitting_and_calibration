function [u,i] = calculate_groundstate_imag_time_GPE_ss(V,par,u0,x,dt_gs)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% calculates ground state of potential V using imaginary step method
% 
% Args:
...
%     u0 (array):                           N_x x 1 initial guess of ground state
%     x (array):                            N_x x 1 spatial values
%     dt_gs (double):                       time discretization for imaginary step
%
% Returns:
%     u (array):                            N_x x 1 calculated groundstate
...
if i == N_max
    fprintf('N_max reached in gs calc\n')
end
